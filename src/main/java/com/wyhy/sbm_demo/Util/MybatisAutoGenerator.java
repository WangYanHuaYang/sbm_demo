...
public class MybatisAutoGenerator {
    ...
    private static final String dateYml="spring.datasource.dynamic.datasource.master";
...
//    }
    ...
    @Value("${"+dateYml+".driver-class-name}")
    private String driver;

    @Value("${"+dateYml+".username}")
    private String username;

    @Value("${"+dateYml+".password}")
