...
public class ${table.controllerName} {
    ...
    */
    ...
    @ResponseBody
    private Msg select${entity}s(@ModelAttribute("${table.name}")${entity} ${table.name},@RequestParam(value = "pageNum",defaultValue = "1")Integer pageNum,@RequestParam(value = "pageSize",defaultValue = "1")Integer pageSize){
